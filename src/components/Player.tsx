...
interface PlayerProps {
  ...
  nowTick?: number; // current game tick — drives status-effect auras (curse/bless/stun)
...
export const Player: React.FC<PlayerProps> = ({
  ...
  return (
    <group ref={group} castShadow>
      ...
      {/* Keeper-effect + loot auras (carry glow / curse / bless / stun). Rides this
          group's predicted transform so it tracks the model with no server lag. */}
      <StatusFx playerData={playerData} nowTick={nowTick} />
